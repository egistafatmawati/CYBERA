...
<body class="font-['Inter'] antialiased text-white min-h-screen relative flex flex-col selection:bg-[#FFC107] selection:text-[#090F31]">
    ...
    <!-- Konten -->
    <div class="flex-grow flex items-center justify-center p-4 mt-10 mb-8 z-10">
        
        <!-- Kartu Register -->
        <div class="w-full max-w-[450px] bg-white/10 backdrop-blur-lg border border-white/20 rounded-[28px] p-8 flex flex-col justify-center shadow-[0_8px_32px_0_rgba(0,0,0,0.3)]">
            
            <div class="w-full mx-auto">
                <!-- Logo -->
                <div class="flex justify-center mb-6">
                    <img src="{{ asset('images/LOGO 1.png') }}" alt="CYBERA Logo" class="h-12 w-auto drop-shadow-[0_0_15px_rgba(255,193,7,0.3)]">
                </div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-5">
                        ...
                        <input id="name" type="text" name="name" value="{{ old('name') }}" required autofocus autocomplete="name" 
                               class="block w-full bg-transparent border border-white/70 text-white placeholder-white/80 focus:border-[#FFC107] focus:ring-[#FFC107] rounded-xl px-4 py-3 transition-colors duration-200" 
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            <input id="password" type="password" name="password" required autocomplete="new-password" 
                                   class="block w-full bg-transparent border border-white/70 text-white placeholder-white/80 focus:border-[#FFC107] focus:ring-[#FFC107] rounded-xl px-4 py-3 pr-12 transition-colors duration-200" 
                                   placeholder="Minimal 8 karakter">
                            
                            <!-- Tombol Toggle Password -->
                            <button type="button" id="togglePassword" class="absolute inset-y-0 right-0 pr-4 flex items-center text-white/80 hover:text-white transition-colors outline-none">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" id="toggleConfirmPassword" class="absolute inset-y-0 right-0 pr-4 flex items-center text-white/80 hover:text-white transition-colors outline-none">
                    ...
                    <!-- Tombol Daftar -->
                    <button type="submit" class="w-full bg-[#FFC107] hover:bg-yellow-400 text-black font-bold py-3.5 px-4 rounded-xl transform hover:scale-[1.02] transition-all duration-200 mb-4 shadow-[0_0_15px_rgba(255,193,7,0.4)]">
                        Daftar
                    </button>
                    
                    <!-- Login Google -->
                    <a href="{{ route('auth.google') }}" class="w-full bg-white hover:bg-gray-100 text-gray-800 font-bold py-3.5 px-4 rounded-xl flex items-center justify-center border border-gray-300 transform hover:scale-[1.02] transition-all duration-200 mb-6 shadow-sm">
                    ...
                    <p class="text-center text-sm text-gray-300">
                        Sudah punya akun? <a href="{{ route('login') }}" class="text-[#FFC107] hover:underline font-bold">Login</a>
                    </p>
                </form>
            </div>
        </div>
