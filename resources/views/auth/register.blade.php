    ...
    <div class="flex-grow flex items-center justify-center p-4 py-8 z-10">
        ...
        <div class="w-full max-w-[460px] bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl rounded-[30px] p-8 sm:p-10">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <!-- Google Login Button -->
                <a href="{{ route('auth.google') }}" class="w-full bg-white hover:bg-gray-100 text-gray-800 font-bold text-[15px] py-3.5 px-4 rounded-xl flex items-center justify-center border border-gray-300 transform hover:scale-[1.02] transition-all duration-200 mb-8 shadow-sm">
