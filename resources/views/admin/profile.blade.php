        ...
        <div class="p-6 md:p-8">
            <form action="#" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" value="Administrator" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-[#090F31] focus:outline-none focus:border-[#090F31] focus:ring-1 focus:ring-[#090F31] transition-colors">
                </div>

                <!-- Email -->
                <div>
                    <label class="block text-sm font-bold text-[#090F31] mb-2">Alamat Email</label>
                    <input type="email" value="admin@cybera.com" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm text-[#090F31] focus:outline-none focus:border-[#090F31] focus:ring-1 focus:ring-[#090F31] transition-colors">
                </div>

                <div class="flex justify-end pt-4">
                    <button type="button" class="bg-[#090F31] text-white font-bold px-8 py-3 rounded-xl hover:bg-gray-800 transition-colors">
                        Simpan Profil
                    </button>
                </div>
            </form>
        ...
        <div class="p-6 md:p-8">
            <form action="#" method="POST" class="space-y-6">
                ...
                <div class="relative" x-data="{ show: false }">
                    ...
                    <input :type="show ? 'text' : 'password'" placeholder="Masukkan password baru" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 pr-12 text-sm text-[#090F31] focus:outline-none focus:border-[#090F31] focus:ring-1 focus:ring-[#090F31] transition-colors">
                ...
                <div class="relative" x-data="{ show: false }">
                    ...
                    <input :type="show ? 'text' : 'password'" placeholder="Ulangi password baru" class="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 pr-12 text-sm text-[#090F31] focus:outline-none focus:border-[#090F31] focus:ring-1 focus:ring-[#090F31] transition-colors">
                    <div @click="show = !show" class="absolute right-4 top-[2.4rem] text-gray-400 cursor-pointer hover:text-gray-600 transition-colors">
                        <svg x-show="!show" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21" />
                        </svg>
